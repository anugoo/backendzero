...
def dt_getuserresume(request):
    ...
    try: 
        ...
        cursor.close() # close the cursor. ALWAYS
        respdata = [{'uid': uid,'uname':uname , 'fname':fname, 'lname':lname, 'skills':skills, 'education':education}] # creating response user resume information
